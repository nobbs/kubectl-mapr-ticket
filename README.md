...
Example installation of `v0.2.2` for Apple Silicon (ARM64) macOS:

```console
$ curl -LO https://github.com/nobbs/kubectl-mapr-ticket/releases/download/v0.2.2/kubectl-mapr-ticket-arm64-darwin.tar.gz
